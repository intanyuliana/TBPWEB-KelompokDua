...
<div class="container-md">
    <a href="kelasadmin.php"><button type="button" class="btn btn-secondary">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
        <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm3.5 7.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>
        </svg>
    </button></a>    
    <h3 align="center">DETAIL KELAS</h3> <br>
        <?php
   ...
   <div class="border border-2 rounded-3" style="padding:5px;width:49%;float:left;margin-left:10px;">
    ...
    ?>
        ...
        <td>
            <a href="hapus_mhs.php?kelas_id=<?php echo $klsid;?>&mhs_id=<?php echo $row['mahasiswa_id']; ?>"><button class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');">Hapus</button></a>
        </td>
        </tr>
    <?php
        }
   ...
   <a href="tambah_pertemuan.php" >
    ...
    ?>
        ...
        <td>
            <a href="detail_pertemuan.php?pertemuan_id=<?php echo $row2['pertemuan_id'];?>"><button class="btn btn-secondary" >Detail</button></a>
        </td>
        </tr>
    <?php
        }
